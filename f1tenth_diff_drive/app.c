...
#define PWM_SERVO_L 410 // 2 ms width
#define PWM_SERVO_S 307 // 1.5 ms width
#define PWM_SERVO_R 205 // 1 ms width
...
// Then map those values to PWM intensities.
    ...
    float angular = constrain(msg.angular.z, -2, 2);
