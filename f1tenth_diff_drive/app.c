...
#define PWM_SERVO_L 409.6 // 2 ms width
#define PWM_SERVO_S 307.2 // 1.5 ms width
#define PWM_SERVO_R 204.8 //1 ms width
...
// Then map those values to PWM intensities.
     ...
     */
     ...
     else if (linear <= -0.3) /* Reverse Drive */
     {
     ...
     else if (linear > -0.3 && linear < 0.3) /* Neutral Drive */
     {
