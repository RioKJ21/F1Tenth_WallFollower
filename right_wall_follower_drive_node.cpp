...
private:
    ...
    for (int i = 0; i < count; i++)
    {
      ...
      ***************************************/
      ...
      { 
        ...
        {
          if (front_view <= 0.6) //SMALLER is better, too small makes lag response
          {
  ...
  void update_callback()
  {
    ...
    float front_dist = 0.6; // Set to LOW for PID TEST Only..........

    double error;
    double pid; 
    
    kp_ = 3.27; // 3.27 How fast the car to steer to the desired point. Higher is better but to much will lead to spinning
