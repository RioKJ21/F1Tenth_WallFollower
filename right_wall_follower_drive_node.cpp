...
private:
  ...
  float last_sum1, last_sum2, last_sum3, last_sum4, last_count1, last_count2, last_count3, last_count4, range_max, range_min;
    ...
    for (int i = 0; i < count; i++)
    {
      ...
      ***************************************/
      ...
      { 
        ...
        if (degree > 10.0 && degree <= 45.0)
        {
          total_left += laser_ranges[i];
          
          if (laser_ranges[i] >= 1.0)
          {
            gap_index_left += i;
            gap_left++;
          }
        ...
        else if (degree < -10.0 && degree >= -45.00)
        {
  ...
  void update_callback()
  {
    ...
    *******************************/
    ...
    //pid = pid - 0.2;
    //steer_gap = steer_gap - 0.2;
    
    /*
    if (pid < 0.0 && error < 0.0)
    {
      pid = pid - 0.2;
    }
    
    if (steer_gap < 0.0 && total_right > total_left)
    {
      steer_gap = steer_gap - 0.2;
    }
    */
