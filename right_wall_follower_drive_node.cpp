...
private:
  ...
  { 
    ...
    if (front_view > 16.0 || front_view < -16.0)
    {
      front_view = 5.0;
    }
  ...
  void update_callback()
  {
    ...
    kd_ = 10.0;	//Damp the car to steer to the desired point. Too high lead to overdamp which makes it too long to get to the desired point. Too low makes it oscilate
